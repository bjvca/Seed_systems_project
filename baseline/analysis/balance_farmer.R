...
#for Caro
baseline_farmers <- read.csv("C:/Users/u0127963/Desktop/PhD/Seed_systems_project/baseline/data/farmer/public/baseline_farmers.csv")

#for Bjorn
# path <- getwd()
# path <- strsplit(path, "/analysis")[[1]]
# baseline_farmers <- read.csv(paste(path,"data/farmer/public/baseline_farmers.csv", sep="/"))

#no treatment indicator for dealer training in baseline_farmers
#treatments at shop level
treatments_shop_level <- read.csv("C:/Users/u0127963/Desktop/PhD/Seed_systems_project/baseline/data/agro_input/raw/treats_shop_level.csv")
...
plot(density(baseline_farmers$Check2.check.maize.q30b, na.rm=T))
table(baseline_farmers$Check2.check.maize.q30b)

#Q50. How many bags of maize did you harvest from this **${plot_select_name}** plot in the second season (entoigo) of 2020?(including maize that was consumed)?
