...
baseline_dealer <- read.csv("C:/Users/u0127963/Desktop/PhD/Seed_systems_project/baseline/data/agro_input/public/baseline_dealer.csv")
...
summary(baseline_dealer_with_score$genderdummy)
...
summary(baseline_dealer_with_score$maize.owner.agree.q5)
...
summary(baseline_dealer_with_score$maize.owner.agree.temp.q69)

#Q71. Do you have a problem with rats or pests (insects, rats)?
summary(baseline_dealer_with_score$maize.owner.agree.temp.q71)

#Q72. Is the roof leak-proof?
summary(baseline_dealer_with_score$maize.owner.agree.temp.q72)

#Q73. Is the roof insulated to keep heat out?
summary(baseline_dealer_with_score$maize.owner.agree.temp.q73)

#Q74. Are the walls insulated to keep the heat out?
summary(baseline_dealer_with_score$maize.owner.agree.temp.q74)

#Q75. Is the area ventilated
summary(baseline_dealer_with_score$maize.owner.agree.temp.q75)

#Q76. Are the walls plastered?
summary(baseline_dealer_with_score$maize.owner.agree.temp.q76)
...
summary(baseline_dealer_with_score$goodfloor)
...
summary(baseline_dealer_with_score$badlighting)
...
summary(baseline_dealer_with_score$badstored)

#Q80. Do you see maize seed that is stored in open bags or open containers?
summary(baseline_dealer_with_score$maize.owner.agree.temp.q80)
...
summary(baseline_dealer_with_score$maize.owner.agree.temp.q81)
...
summary(baseline_dealer_with_score$maize.owner.agree.q96)

#Q70. Entert the temperature in the seed store (where seed is stored)
summary(baseline_dealer_with_score$maize.owner.agree.q70)

# #moisture
# summary(baseline_dealer_with_score$reading)

summary(lm(score~genderdummy + maize.owner.agree.age + prim + maize.owner.agree.q3 + maize.owner.agree.q4 + maize.owner.agree.q5 + years_shop + maize.owner.agree.temp.q69 + maize.owner.agree.temp.q71 + maize.owner.agree.temp.q72 + maize.owner.agree.temp.q73 + maize.owner.agree.temp.q74 + maize.owner.agree.temp.q75 + maize.owner.agree.temp.q76 + goodfloor + badlighting + badstored + maize.owner.agree.temp.q80 + maize.owner.agree.temp.q81 + maize.owner.agree.temp.q82 + maize.owner.agree.q96 + maize.owner.agree.q70, data = baseline_dealer_with_score))