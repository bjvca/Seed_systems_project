...
baseline_farmers=subset(baseline_farmers,Check2.check.maize.q25a=="1")
...
#6.
index_overallprimF_midT <- icwIndex(xmat=variables_overallprimF_mid,sgroup = baseline_farmers$training_control,revcols = c(3,4))
baseline_farmers$index_overallprimF_midT <- index_overallprimF_midT$index

index_overallprimF_baseT <- icwIndex(xmat=variables_overallprimF_base,sgroup = baseline_farmers$training_control,revcols = c(3,4))
...
#6.
index_overallprimF_midC <- icwIndex(xmat=variables_overallprimF_mid,sgroup = baseline_farmers$clearing_control,revcols = c(3,4))
baseline_farmers$index_overallprimF_midC <- index_overallprimF_midC$index

index_overallprimF_baseC <- icwIndex(xmat=variables_overallprimF_base,sgroup = baseline_farmers$clearing_control,revcols = c(3,4))
...
#6.
index_overallprimF_midF <- icwIndex(xmat=variables_overallprimF_mid,sgroup = baseline_farmers$farmer_control,revcols = c(3,4))
baseline_farmers$index_overallprimF_midF <- index_overallprimF_midF$index

index_overallprimF_baseF <- icwIndex(xmat=variables_overallprimF_base,sgroup = baseline_farmers$farmer_control,revcols = c(3,4))
