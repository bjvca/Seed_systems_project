...
baseline_farmers$mid_Check2.check.maize.q51a <- baseline_farmers$mid_farmerswitched #placeholder
...
baseline_farmers$mid_Check2.check.maize.q51b <- baseline_farmers$mid_farmerswitched #placeholder
