...
midline_rating_dyads$bought_at_dealer<-ifelse(midline_rating_dyads$bought_at_dealer=="Yes",1,0)
midline_rating_dyads$customer_years <- 2021 - as.numeric(as.character(substr(midline_rating_dyads$duration_customer,start=1,stop=4))) #dealer baseline data collection in 2020, CH rating dissemination in 2021
midline_rating_dyads$knows_other_customer<-ifelse(dealer_services_dyads$knows_other_customer=="Yes",1,0)
midline_rating_dyads$refunds<-ifelse(midline_rating_dyads$refunds=="Yes",1,0)
midline_rating_dyads$gives_credit<-ifelse(midline_rating_dyads$gives_credit=="Yes",1,0)
midline_rating_dyads$gives_advice<-ifelse(midline_rating_dyads$gives_advice=="Yes",1,0)
midline_rating_dyads$delivers<-ifelse(midline_rating_dyads$delivers=="Yes",1,0)
midline_rating_dyads$after_sales_service<-ifelse(midline_rating_dyads$after_sales_service=="Yes",1,0)
midline_rating_dyads$payment_mehtods<-ifelse(midline_rating_dyads$payment_mehtods=="Yes",1,0)
midline_rating_dyads$small_quant<-ifelse(midline_rating_dyads$small_quant=="Yes",1,0)
...
#farmers
midline_dealer_services_dyads_aggr_F <- aggregate(midline_rating_dyads,by=list(midline_rating_dyads$farmer_ID),FUN="mean",na.rm=T)
midline_dealer_services_dyads_aggr_F = midline_dealer_services_dyads_aggr_F[c("Group.1","knows_dealer"
                                                              ,"bought_at_dealer","customer_years"
                                                              ,"knows_other_customer","refunds"
                                                              ,"gives_credit","gives_advice"
                                                              ,"delivers","after_sales_service"
...
names(midline_dealer_services_dyads_aggr_F) <- c("Group.1","mid_knows_dealer"
                                                              ,"mid_bought_at_dealer","mid_customer_years"
                                                              ,"mid_knows_other_customer","mid_refunds"
                                                              ,"mid_gives_credit","mid_gives_advice"
                                                              ,"mid_delivers","mid_after_sales_service"
...
baseline_farmers$mid_Check2.check.maize.q25d <- as.numeric(as.character(baseline_farmers$check.maize.q25d))
