...
names(reviews_seed_baseline)[names(reviews_seed_baseline) == "score_corrected"] <- "rat_of_dealer_farmer_chose_at_baseline_at_baseline"
...
names(reviews_seed_midline)[names(reviews_seed_midline) == "score_corrected"] <- "rat_of_dealer_farmer_chose_at_midline_at_midline"

rating_dyads_midline <- merge(rating_dyads_midline,reviews_seed_midline,by="shop_ID")

reviews_seed_baseline <- read.csv(paste(path,"/baseline/data/agro_input/public/reviews_seed.csv", sep="/"), stringsAsFactors = TRUE)
names(reviews_seed_baseline)[names(reviews_seed_baseline) == "score_corrected"] <- "rat_of_dealer_farmer_chose_at_midline_at_baseline"

rating_dyads_midline <- merge(rating_dyads_midline,reviews_seed_baseline,by="shop_ID")
...
mean(rating_dyads_baseline_midline$rat_of_dealer_farmer_chose_at_baseline_at_baseline,na.rm = T)
mean(rating_dyads_baseline_midline$rat_of_dealer_farmer_chose_at_midline_at_baseline,na.rm = T)

rating_dyads_baseline_midline$diff_between_rat_at_baseline <- rating_dyads_baseline_midline$rat_of_dealer_farmer_chose_at_midline_at_baseline - rating_dyads_baseline_midline$rat_of_dealer_farmer_chose_at_baseline_at_baseline 
